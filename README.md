...
Обратите внимание, для авторизации расширения используется OAuth2 сервер, собранный проект уже настроен на тот же сервер что и расширение для Chrome (публичный ключ в  файле src/main/resources/public-key.txt)
